...
def search_keywords_in_files(files: list, keywords: list[str,], result_queue: Queue):
    """Function to search for keywords in specific files and add it to a common queue if a keyword is found in the file"""
    ...
    for file in files:
        ...
        except (FileNotFoundError, IsADirectoryError, PermissionError, UnicodeDecodeError) as err:
